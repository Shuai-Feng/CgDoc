      ...
      <div>
        <Card style={{ marginBottom: '10px' }}>
          ...
          <Button style={{ float: 'right' }} type="text">
            {orderNum ? (
              <span>{orderNum}个订单未完成</span>
            ) : (
              <Tag color="green">订单全部完成</Tag>
            )}
          </Button>
        </Card>
        <div style={{ background: '#fff', padding: '10px' }}>
          ...
          <Table
            ...
            scroll={
              document.documentElement.clientWidth < 800 ? { x: '100%' } : {}
            }
            pagination={{
              pageSize: 12,
              total: 100,
        ...
        >
          ...
          this.state.operaType == 'view' ? (
            <Descriptions layout="vertical" bordered title={rowData.medic_name}>
              ...
              <DescrItem label="是否完成">
                {rowData.medic_status ? '已完成' : '未完成'}
              </DescrItem>
